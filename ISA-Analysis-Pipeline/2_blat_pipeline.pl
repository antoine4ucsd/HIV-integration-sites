...
use lib '/yourpath/ISA-Analysis-Pipeline'; # Change this path to the location of your modules.
use ISAbatchFilter;
use ISAblatFilter;
use ISAdataReformat;
...
my $path2_11ooc = "/mypath/ISA-Analysis-Pipeline/11.ooc"; # Location of 11.ooc file required for BLAT						   		
my $path2blat = "/Users/antoinechaillon/anaconda2/bin/blat"; # The path of the BLAT application
my $path2hg19 = "/yourpath/_ISA_HumanGenome/chr"; # The path to the human chromosome files
my $path2HIV = "/yourpath/_ISA_pipeline/_hiv_genome/HIV1_complete_genome.$chr_ext"; # Path to the HIV genome /Users/antoinechaillon/Documents/_ISA_pipeline/_hiv_genome/HIV1_complete_genome.fa
my $path2uclust = "/yourpath/ISA-Analysis-Pipeline/uclust"; # Path to the Uclust program.
